...
Global Const $AUTO_MODE_SKILL_CAST = 3
Global Const $AUTO_MODE_CHANNEL_MOVE = 4
Global Const $AUTO_MODE_ITEM_ENCHANT_CONTOK = 5
Global Const $AUTO_MODE_ITEM_ENCHANT_OFFERING = 6
Global Const $AUTO_MODE_ITEM_ENCHANT_REAL = 7
Global Const $AUTO_MODE_SCROLL_ENCHANT_REAL = 8
Global Const $AUTO_MODE_STONE_HANDWORK = 9
...
Global const $CHECK_STATUS_FULL_HEALTH[1] = ["44.92:89.75|0x550907|1|3"]
